        ...
        <table>
            ...
            <tr>
                <td><span>Ещё раз E-mail:</span></td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td><span>Подтверждение<br /> пароля:</span></td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td><span id="tooltip_security_question" class="underline_tooltip">Секретный вопрос:</span></td>
                <td>&nbsp;</td>
                <td>
                    <select id="register_question" name="question" id="type" class="register_question">
                        <option value="Ваш любимый фильм?"
                            <?php if ($registerArgs->question == "Ваш любимый фильм?") {
                                echo " selected = selected";
                            } ?>                
                        >Ваш любимый фильм?</option>
                        <option value="Дата вашего рождения?" 
                            <?php if ($registerArgs->question == "Дата вашего рождения?") {
                                echo " selected = selected";
                            } ?>        
                        >Дата вашего рождения?</option>
                        <option value="Кличка вашего питомца?"
                            <?php if ($registerArgs->question == "Кличка вашего питомца?") {
                                echo " selected = selected";
                            } ?>                        
                        >Кличка вашего питомца?</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td><span>Ответ на секретный<br />вопрос:</span></td>
                <td>&nbsp;</td>
