 ...
 * Time: 13:58
 */
class logdata_admin_remove_clan_item extends logdata_prototype {
    public $fields = array(
        'item', 'count'
    );
    public $message ='Из кладовки вашего клана изъяты ресурсы: %s х %s шт. Администрация';
    public $type = 'admin_remove_clan_item';
