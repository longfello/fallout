 ...
 * Time: 13:58
 */
class logdata_player_buy_toxic_item extends logdata_prototype {
  public $fields = array(
    'link', 'player_name', 'item', 'quantity', 'cost'
  );
  public $message ='<b><a href="%s">%s</a></b> купил ваш предмет %s в количестве %s на рынке в Токсических пещерах. <b>%s</b> золота добавлено на ваш счёт в банке в Токсических пещерах.';
  public $type = 'player_buy_toxic_item';
