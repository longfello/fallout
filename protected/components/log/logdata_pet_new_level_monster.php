 ...
 * Time: 13:58
 */
class logdata_pet_new_level_monster extends logdata_prototype {
  public $fields = array(
    'monsters_ids'
  );
  public $message ='Во время боя с <b>%s</b>, Ваш питомец перешёл на новый уровень.';
  public $type = 'pet_new_level_monster';
