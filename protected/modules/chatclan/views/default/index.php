...
<hr />
<div id="volnorez_live_player" style="width:450px;height:27px;display:block;color:#33cc00"><br /><?= t::get('Слушать') ?> <a href="//volnorez.com/radio-revival-online" title="<?= t::get('радио Radio Revival Online') ?>"><?= t::get('радио Radio Revival Online') ?></a><br /><script type="text/javascript">var jscode_player_id="00133e35";var jscode_options="1f";var cShareBtnMode="local";var cSkinURL_player="//volnorez.com/application/maxsite/plugins/wcdesign/skins/liveplayer_skin_modern.swf";var cSkinParams_player="clr_skin:0,clr_text:33cc00,clr_btn:33cc00,clr_btn_h:ccff00,clr_btn_d:ccff00,clr_volume:ccff00";</script><br /><script type="text/javascript" src="//volnorez.com/application/maxsite/plugins/jscode/js/jscode_player.js"></script><br /></div>
<hr />
<br>
<a href="radio.php?back=chatclan"><?= t::get('Радио') ?></a>   |
...
<hr />
<div id="ignoreInfo">
    <?= t::get('У вас в игноре') ?> <span id="ignoreCount"></span> <?= t::get('человек(а)') ?>: <span id="ignorePlayers"></span>
</div>
<div id="ignoreList">
...
<div class="smileContainer">
    <div id="hiddenSmiles" class="smiles">
        ...
        <img name="40" img src="/images/smilies/bn.gif" border="0" alt="*DONT_KNOW*">
