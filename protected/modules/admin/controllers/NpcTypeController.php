...
class NpcTypeController extends Controller
{
	...
	*/
	public function actionCreate(){
		...
		if(isset($_POST['NpcType'])){
			$model->attributes=$_POST['NpcType'];
			if($model->save())
	...
	*/
	public function actionIndex(){
		$model=new NpcType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['NpcType']))
			$model->attributes=$_GET['NpcType'];
	...
	*/
	public function loadModel($id){
		$model=NpcType::model()->findByPk($id);
		if($model===null)
	...
	*/
	protected function performAjaxValidation($model){
		if(isset($_POST['ajax']) && $_POST['ajax']==='npc-type-form')
		{
