...
// $this->widget('zii.widgets.grid.CGridView', array(
  ...
  'type' => TbHtml::GRID_TYPE_HOVER,
	...
	'columns'=>array(
        ...
        'filter'=> CHtml::dropDownList('LanguageTranslate[lang_id]', $model->lang_id, Chtml::listData(Language::model()->findAll(), 'id', 'name'), array( 'empty' => '-' )),
    ),
		'slug' =>  array(
        'name'=>'slug',
        'type'=>'html',
...
//        'value' => 'mb_strlen(htmlentities($data->value, null, "UTF-8"))>100?mb_substr(htmlentities($data->value, null, "UTF-8"), 0, 100)."...":htmlentities($data->value, null, "UTF-8")',
        'editable' => array(
          'type' => 'textarea',
          'url' => $this->createUrl('admin/editable'),
          'placement' => 'right',
          'inputclass' => 'span3'
        )
    ),
