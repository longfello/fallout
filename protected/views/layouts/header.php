...
<head>
    ...
    Yii::app()->clientScript->registerCssFile('/css/jquery-ui/jquery-ui-1.9.2.custom.css');
    Yii::app()->clientScript->registerCssFile('/css/tipped.css');

    Yii::app()->clientScript->registerScriptFile('/js/i18n/'.t::iso().'/lang.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/jquery.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/jquery-ui.min.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/jquery.tooltip.min.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/jquery.caret.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/frame.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/components/jquery.history.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/system.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/extra.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/spinners.min.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/tipped.js', CClientScript::POS_HEAD);
    Yii::app()->clientScript->registerScriptFile('/js/show_inf.js', CClientScript::POS_HEAD);
    ?>
    <!-- START Код Google Analitics -->
    <script type="text/javascript">

        var _gaq = _gaq || [];
        _gaq.push(['_setAccount', 'UA-71161923-1']);
        _gaq.push(['_setDomainName', 'revival.online']);
...
<div id="wrapper">
    <div id="player_menu">
        ...
        <div id="player_button"><a href="/stats.php?status=info"><img src="/images/frame/<?=t::iso()?>/player_up_off.png" /></a>
        </div>
    </div>
            ...
            <tr>
                <td class="info_menu_content">
                    <div id="info_block">
                        ...
                        <a id="obj_mail_link" href="/mail.php"><img  id="obj_mail_img" src="/images/unread.gif" align="absmiddle" alt="<?=t::get('Почта')?>" /></a>
                          <?php t::widget(); ?>
                        </div>
                        <ul id="stats">
                            <li>
                                <img src="/images/frame/icon_hp.png" class="img_stat" />
                            ...
                            <li>
                                <img src="/images/frame/icon_energy.png" class="img_stat" />
                                <span class="tooltip_box">
                            ...
                            <li>
                                <img src="/images/frame/icon_weight.png" class="img_stat" />
                            <span class="tooltip_box">
                ...
                <tr>
                    <td class="vertical_menu_content">
                        ...
                        <table id="vertical_button">
                            ...
                            <?php  $last_news = _mysql_fetch_object(_mysql_exec(" SELECT `id` FROM `news` WHERE `section`='news' AND `active`='1' ORDER BY `id` DESC LIMIT 1")); ?>
                            <tr>
                                <td><a href="/new/<?= $last_news->id; ?>"><img src="/images/frame/<?=t::iso()?>/news_normal_<?php echo (!intval(Yii::app()->stat->read_news)) ? 'ron' : 'roff'; ?>.png" /></a></td>
                            </tr>
                            <tr>
                        ...
                        <table class="banner_border">
                            ...
                            <tr>
                                ...
                                <td class="banner_content">
                                    ...
                                    <a href="//revival.online/donate.php"><img width="95px" height="100px" src="/images/banners/<?= t::iso() ?>/donate1.png" title="<?=t::get('Купить крышки!')?>" alt="<?=t::get('Купить крышки!')?>"/></a>
                                </td>
        ...
        <table id="table_content">
            <tr>
                ...
                <td class="table_content_center_header">
                    ...
                    <div class="page_title"><marquee behavior="slide"><?= $this->pageTitle?></marquee></div></td>
