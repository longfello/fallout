...
class Clans extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, public_msg, private_msg, pass, war_win, union_win', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'name' => 'Название клана',
			'owner' => 'ID (из players) главы клана',
			'coowner' => 'ID (из players) советника клана',
			'gold' => 'Количество золота в кладовке клана',
			'platinum' => 'Количество крышек в кладовке клана',
			'public_msg' => 'Общедоступное описание клана',
			'private_msg' => 'Описание для соклановцев',
			'tag' => 'Tag',
			'pass' => 'Пароль клана, без шифрования',
			//'moneypass' => '[ НЕ ИСПОЛЬЗУЕМОЕ ПОЛЕ ]',
			'hospass' => 'Клановый лекарь',
			//'clanwars' => '[ НЕ ИСПОЛЬЗУЕМОЕ ПОЛЕ ]',
			//'chatroom' => '[ НЕ ИСПОЛЬЗУЕМОЕ ПОЛЕ ]',
			//'clanstore' => '[ НЕ ИСПОЛЬЗУЕМОЕ ПОЛЕ ]',
			'clan_tax_ranges' => 'Размер кланового налога',
			'war_win' => 'Всего убийств врагов',
			'union_win' => 'Всего убийств союзников',
		);
	}
