...
/**
 * This is the model class for table "player_exp".
 *
 ...
 */
class PlayerExp extends CActiveRecord
{
	/**
  ...
  public static function getExperienceForNextLevel($current_level){
    ...
    /** @var $model PlayerExp */
    $model = PlayerExp::model()->find($criteria);

    $expn_pet = (($current_level * $model->er1) + ($current_level * $model->er2) * ($current_level) * $model->er);
